...
export default [
        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/乌合之众/',
                component: ComponentCreator('/docs/乌合之众/', 'e3f'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/1',
                component: ComponentCreator('/docs/乌合之众/1', 'c10'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/10',
                component: ComponentCreator('/docs/乌合之众/10', '0da'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/11',
                component: ComponentCreator('/docs/乌合之众/11', '5b9'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/12',
                component: ComponentCreator('/docs/乌合之众/12', '5a4'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/13',
                component: ComponentCreator('/docs/乌合之众/13', 'be8'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/14',
                component: ComponentCreator('/docs/乌合之众/14', 'd8b'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/2',
                component: ComponentCreator('/docs/乌合之众/2', 'cd0'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/3',
                component: ComponentCreator('/docs/乌合之众/3', '1c6'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/4',
                component: ComponentCreator('/docs/乌合之众/4', '7e5'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/5',
                component: ComponentCreator('/docs/乌合之众/5', '6c3'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/6',
                component: ComponentCreator('/docs/乌合之众/6', 'bbf'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/7',
                component: ComponentCreator('/docs/乌合之众/7', '593'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/8',
                component: ComponentCreator('/docs/乌合之众/8', 'f30'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
                path: '/docs/乌合之众/9',
                component: ComponentCreator('/docs/乌合之众/9', 'd4d'),
                exact: true,
                sidebar: "bookSidebar"
              },
              {
  ...
  {
    path: '/terminology',
    component: ComponentCreator('/terminology', 'ed1'),
    routes: [
      {
        path: '/terminology',
        component: ComponentCreator('/terminology', '9b7'),
        routes: [
          {
            path: '/terminology',
            component: ComponentCreator('/terminology', 'cea'),
            routes: [
              {
